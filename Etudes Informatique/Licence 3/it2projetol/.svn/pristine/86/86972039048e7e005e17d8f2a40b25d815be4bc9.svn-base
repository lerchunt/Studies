...
int test_glushkov(){
    ...
    {
       Rationnel * rat;
       rat = expression_to_rationnel("a+b+c");
       numeroter_rationnel(rat);
       Automate * automate = Glushkov(rat);
       printf("1eme automate\n ");
       printf("--------------------\n");
       ...
       TEST(
          ...
          && le_mot_est_reconnu(automate, "a")
          && le_mot_est_reconnu(automate, "b")
          && le_mot_est_reconnu(automate, "c")
	  && !le_mot_est_reconnu(automate, "a.b.c")
          && !le_mot_est_reconnu(automate, "")
          && !le_mot_est_reconnu(automate, "a*")
