...
/**
 * @brief Affecte les positions <b>position_min</b> et
...
/**
 * @brief Teste si le langage d'une expression rationnelle contient le mot vide.
...
/**
 * @brief Calcule l'ensemble des positions des lettres pouvant apparaître comme première lettre d'un mot du langage d'une expression rationnelle.
...
/**
 * @brief Calcule l'ensemble des positions des lettres pouvant apparaître comme dernière lettre d'un mot du langage d'une expression rationnelle.
 * @param rat L'expression rationnelle.
...
/**
 * @brief Calcule l'ensemble des positions des lettres pouvant suivre une position donnée dans au moins un mot du langage de l'expression. 
