	...
	public static void main(String[] args) {
		if(args[0]!=null){
			...
			String sparqlQuery = "" +
					...
					"SELECT DISTINCT ?birthdate ?birthplace ?abstract \n"+
					"WHERE {\n"+
						"author:"+args[0]+" owl:sameAs ?au .\n"+
						"SERVICE <http://dbpedia.org/sparql> { ?au dbo:birthDate ?birthdate ;dbo:birthPlace ?birthplace ;dbo:abstract ?abstract . }\n"+
