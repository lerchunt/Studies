	...
	*) echo 'Filename must end in ".c"' >&2; exit 1;;
	...
	echo "${CC=cc} -c ${CFLAGS=-fprofile-arcs -ftest-coverage} $0 -o dry1.o"
	...
	gcov dry.c
	mv dry.c.gcov Resultatgcov1.txt
	echo "${CC=cc} -c -DREG ${CFLAGS=-fprofile-arcs -ftest-coverage} $0 -o dry1.o"
	...
	gcov dry.c
	mv dry.c.gcov Resultatgcov2.txt
	echo "${CC=cc} -c -O ${CFLAGS=-fprofile-arcs -ftest-coverage} $0 -o dry1.o"
	...
	gcov dry.c
	mv dry.c.gcov Resultatgcov3.txt
	rm -f dry1.o
