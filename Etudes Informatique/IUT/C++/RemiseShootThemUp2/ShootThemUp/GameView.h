...
class GameView {
	private:
		...
		sf::SoundBuffer _buffer;	// son du tir de la sorciere
		sf::SoundBuffer _buffer2;	//son du dragon
		sf::SoundBuffer _buffer_secondaire; 	//son du tir secondaire
		sf::Sound _sound;
		sf::Sound _sound_secondaire;
